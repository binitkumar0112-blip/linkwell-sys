...
import { Menu, X, ChevronDown, LogOut, LayoutDashboard, MapPin, Users, Building2, Package, Lock } from 'lucide-react';
                    ...
                    <div className="p-1.5 space-y-0.5">
                      ...
                      <div className="border-t border-slate-100 mt-1 pt-1">
                        <Link to="/auth/operator"
                          ...
                          onClick={() => setLoginDropOpen(false)}>
                          <div className="w-7 h-7 rounded-lg flex items-center justify-center shrink-0 bg-slate-200">
                            <Lock className="h-3.5 w-3.5 text-slate-600" />
                          </div>
                          <div>
                            <p className="font-semibold text-slate-600">Operator</p>
